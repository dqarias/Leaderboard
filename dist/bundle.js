...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_addScoreUser_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/addScoreUser.js */ \"./src/modules/addScoreUser.js\");\n/* harmony import */ var _modules_getScoreUsers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/getScoreUsers.js */ \"./src/modules/getScoreUsers.js\");\n\n\n\n\nconst btnAddUser = document.getElementById('add_score');\nconst btnRefreshScore = document.getElementById('refresh');\nconst scoresUsers = document.querySelector('.scores__body');\nconst inputUser = document.getElementById('name');\nconst inputScore = document.getElementById('score');\n\nconst addScore = () => {\n  if (inputUser.value && inputScore.value) {\n    (0,_modules_addScoreUser_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(inputUser.value, Number(inputScore.value));\n  }\n  inputUser.value = '';\n  inputScore.value = '';\n};\n\nconst renderScores = () => {\n  const userScore = (0,_modules_getScoreUsers_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  scoresUsers.innerHTML = '';\n  userScore.then((scores) => {\n    scores.sort((a, b) => b.score - a.score);\n    scores.forEach((element) => {\n      scoresUsers.innerHTML += `<li class=\"scores__list\">${element.user} : ${element.score}</p></li>`;\n    });\n  });\n};\n\nbtnAddUser.addEventListener('click', addScore);\nbtnRefreshScore.addEventListener('click', renderScores);\n\n//# sourceURL=webpack://webpack-boilerplate/./src/index.js?");

/***/ }),

/***/ "./src/modules/addScoreUser.js":
/*!*************************************!*\
  !*** ./src/modules/addScoreUser.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _baseurl_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./baseurl.js */ \"./src/modules/baseurl.js\");\n\n\nconst addNewScoreUser = async (user, score) => {\n  const response = await fetch(`${_baseurl_js__WEBPACK_IMPORTED_MODULE_0__.URL_BACKEND}/${_baseurl_js__WEBPACK_IMPORTED_MODULE_0__.GamesId}/scores/`, {\n    method: 'POST',\n    body: JSON.stringify({\n      user, score,\n    }),\n    headers: {\n      'Content-type': 'application/json; charset=UTF-8',\n    },\n  });\n  const messageAddScore = await response.json();\n  return messageAddScore;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addNewScoreUser);\n\n//# sourceURL=webpack://webpack-boilerplate/./src/modules/addScoreUser.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"GamesId\": () => (/* binding */ GamesId),\n/* harmony export */   \"URL_BACKEND\": () => (/* binding */ URL_BACKEND)\n/* harmony export */ });\nconst URL_BACKEND = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games';\nconst GamesId = 'szQCyqxBkLCecH9TPXE3';\n\n\n\n\n//# sourceURL=webpack://webpack-boilerplate/./src/modules/baseurl.js?");

/***/ }),

/***/ "./src/modules/getScoreUsers.js":
/*!**************************************!*\
  !*** ./src/modules/getScoreUsers.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _baseurl_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./baseurl.js */ \"./src/modules/baseurl.js\");\n\n\nconst getScoreUsers = async () => {\n  const response = await fetch(`${_baseurl_js__WEBPACK_IMPORTED_MODULE_0__.URL_BACKEND}/${_baseurl_js__WEBPACK_IMPORTED_MODULE_0__.GamesId}/scores/`);\n  const userData = await response.json();\n  return userData.result;\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getScoreUsers);\n\n//# sourceURL=webpack://webpack-boilerplate/./src/modules/getScoreUsers.js?");
